  ...
  <footer className="footer">
    <Container>
      <Row>
        ...
        <div className="logo">
                  <div>
                  <h1 className='text-white'>AlokMart</h1>
                  </div>
              </div>
        ...
        <Col lg='12'>
          <p className='footer__copyright'>Copyright {year} developer by alokms. All rights reserved</p>
        </Col>
      </Row>
    </Container>
  </footer>
